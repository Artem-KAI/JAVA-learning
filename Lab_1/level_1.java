...
// Список реалізований за допомогою масиву
// Змінна size показує, скільки елементів зараз у списку
// Додавання — запис у масив + збільшення size
// Видалення — зсув елементів вліво
// Виведення — звичайний цикл for